...
const { yellow, green, cyan, magenta, lightRed, stripColors } = require('kolorist')

const cwd = process.cwd()

// const TEMPLATES = [yellow('library'), magenta('base')]
...
async function init() {
  ...
  console.log(`  ${pkgManager === 'yarn' ? `yarn coverage` : `npm run coverage`}`)
  console.log()
}
